...
function WhatDoWeDo() {
  return (
    <div className="border-1 border-twc_border mt-10 rounded-lg px-5 py-6 backdrop-blur-lg">
      ...
      <div className="mx-auto mb-2 mt-8 max-w-[450px]">
        <Image src={chartImage} alt="crypto-chart" className="max-w-full" />
      </div>
      <p className="text-twc_secondary text-justify">
        ...
        safety of our users’ funds. With a focus on liquidity, reliability, and
        innovation, we aim to become a trusted gateway to the world of
        cryptocurrencies, empowering our customers to participate in the global
